...
using Soenneker.Figma.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Figma.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Figma:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/figma/rest-api-spec/main/openapi/openapi.yaml";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "FigmaOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
